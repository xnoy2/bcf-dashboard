        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="./client_project.php" class="nav-link active">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Client Projects</h3></div>
            </div>
            <!--end::Row-->
          </div>
          <!--end::Container-->
        ...
        <div class="app-content">
          ...
          <div class="col-md-3">
            <div class="info-box">
              <span class="info-box-icon text-bg-info"><i class="fa fa-folder"></i></span>
          ...
          <div class="col-md-3">
            <div class="info-box">
              <span class="info-box-icon text-bg-primary"><i class="fa fa-project-diagram"></i></span>
              <div class="info-box-content">
                <span class="info-box-text">Active Projects</span>
                <span class="info-box-number" id="kpi-active">0</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="info-box">
              <span class="info-box-icon text-bg-success"><i class="fas fa-check-circle"></i></span>
              <div class="info-box-content">
          ...
          <div class="col-md-3">
            <div class="info-box">
              <span class="info-box-icon text-bg-warning"><i class="fas fa-clock"></i></span>
              <div class="info-box-content">
